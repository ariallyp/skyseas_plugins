...
import com.skyseas.openfireplugins.group.iq.user.InviteResultHandler;
...
final class IQDispatcher implements GroupIQDispatcher {
    ...
    public static void groupIQConfig(IQDispatcher dispatcher) {
        ...
        // Group  "http://skysea.com/protocol/group";   群操作
        ...
        // Member  "http://skysea.com/protocol/group#member";  群内普通用户
        ...
        // Owner "http://skysea.com/protocol/group#owner";  群拥有者
        ...
        // User  "http://skysea.com/protocol/group#user";  未加入群的用户
        dispatcher.installHandler(ApplyJoinGroupHandler.class);
        dispatcher.installHandler(InviteResultHandler.class);
    }
