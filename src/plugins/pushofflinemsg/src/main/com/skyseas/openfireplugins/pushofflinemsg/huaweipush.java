...
public class huaweipush
{
    ...
    private static final Logger Log = LoggerFactory.getLogger(huaweipush.class);
    /**
     * 方法表述
     * 
     * @param args
...
//            oauth2Client.initKeyStoreStream(huaweipush.class.getResource("/mykeystorebj.jks").openStream(), "123456");
//            String appId = "10793221";
//            String appKey = "a032c305631ca3a24ca3692d8380067d";
//            
...
//            client.initKeyStoreStream(huaweipush.class.getResource("/mykeystorebj.jks").openStream(), "123456");//如果访问https必须导入证书流和密码
//            
//            //调用push单发接口
////            single_send(client);
//            
...
//    }
     ...
     * @throws NSPException
     */
    public static void single_send(NSPClient client,String content)
        throws NSPException
    {
        ...
        String token = "0867982020798188300000219200CN01";
        ...
        Log.info("单发接口消息响应:" + resp.getResultcode() + ",message:" + resp.getMessage());
    }
     ...
     * @throws NSPException
     */
    public static void ps_single_send(NSPClient client,String content,String token,String title)
        throws NSPException
    {
        ...
        // 目标用户，必选。
        // 由客户端获取， 32 字节长度。手机上安装了push应用后，会到push服务器申请token，申请到的token会上报给应用服务器
       //  token = "0867982020798188300000239400CN01";
        
        // 发送到设备上的消息，必选
        // 最长为4096 字节（开发者自定义，自解析）
        String android = "{\"notification_title\":\""+title+"\",\"notification_content\":\""+content+"\",\"doings\":1}";
