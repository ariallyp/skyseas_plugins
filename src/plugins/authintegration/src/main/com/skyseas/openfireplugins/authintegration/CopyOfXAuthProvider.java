//package skyseas.openfireplugins.authintegration;
//
...
//
//public class CopyOfXAuthProvider implements AuthProvider, PropertyEventListener {
//
//	private Logger logger = LoggerFactory.getLogger(CopyOfXAuthProvider.class);
